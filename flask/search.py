...
from backend.SearchPages import get_search_handler,init_lucene,init_search_handler,lucene
from flask import (
...
def search_results():
    ...
    return render_template('search/search_results.html',lucene_results=lucene_results)
    if results:
